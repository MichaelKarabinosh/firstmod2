...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> CRYONITE_ARMOR_MATERIAL = register("alexandrite", Util.make(new EnumMap<>(ArmorItem.Type.class),
            attribute -> {
            ...
            }), 15, 4f, 0.1f, () -> ModItems.CRYONITE.get());
